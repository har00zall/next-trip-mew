...
class HoliChennaiRecord extends FirestoreRecord {
  HoliChennaiRecord._(
  ...
  static Stream<HoliChennaiRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => HoliChennaiRecord.fromSnapshot(s));

  static Future<HoliChennaiRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => HoliChennaiRecord.fromSnapshot(s));

  static HoliChennaiRecord fromSnapshot(DocumentSnapshot snapshot) =>
      HoliChennaiRecord._(
        snapshot.reference,
  ...
  static HoliChennaiRecord getDocumentFromData(
    ...
    DocumentReference reference,
      ...
      HoliChennaiRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'HoliChennaiRecord(reference: ${reference.path}, data: $snapshotData)';
}

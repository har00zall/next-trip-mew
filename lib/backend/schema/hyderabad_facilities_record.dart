...
class HyderabadFacilitiesRecord extends FirestoreRecord {
  HyderabadFacilitiesRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('hyderabadFacilities');

  static Stream<HyderabadFacilitiesRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => HyderabadFacilitiesRecord.fromSnapshot(s));

  static Future<HyderabadFacilitiesRecord> getDocumentOnce(
          DocumentReference ref) =>
      ref.get().then((s) => HyderabadFacilitiesRecord.fromSnapshot(s));

  static HyderabadFacilitiesRecord fromSnapshot(DocumentSnapshot snapshot) =>
      HyderabadFacilitiesRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static HyderabadFacilitiesRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      HyderabadFacilitiesRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'HyderabadFacilitiesRecord(reference: ${reference.path}, data: $snapshotData)';
}

Map<String, dynamic> createHyderabadFacilitiesRecordData({
  String? column10,
  String? column11,
  String? column12,
  String? column13,

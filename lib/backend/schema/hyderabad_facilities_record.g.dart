...
part of 'hyderabad_facilities_record.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<HyderabadFacilitiesRecord> _$hyderabadFacilitiesRecordSerializer =
    new _$HyderabadFacilitiesRecordSerializer();

class _$HyderabadFacilitiesRecordSerializer
    implements StructuredSerializer<HyderabadFacilitiesRecord> {
  @override
  final Iterable<Type> types = const [
    HyderabadFacilitiesRecord,
    _$HyderabadFacilitiesRecord
  ];
  @override
  final String wireName = 'HyderabadFacilitiesRecord';

  @override
  Iterable<Object?> serialize(
      Serializers serializers, HyderabadFacilitiesRecord object,
  ...
  @override
  HyderabadFacilitiesRecord deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new HyderabadFacilitiesRecordBuilder();
...
class _$HyderabadFacilitiesRecord extends HyderabadFacilitiesRecord {
  @override
  ...
  factory _$HyderabadFacilitiesRecord(
          [void Function(HyderabadFacilitiesRecordBuilder)? updates]) =>
      (new HyderabadFacilitiesRecordBuilder()..update(updates))._build();

  _$HyderabadFacilitiesRecord._(
      {this.column10,
      this.column11,
      this.column12,
      this.column13,
  ...
  @override
  HyderabadFacilitiesRecord rebuild(
          void Function(HyderabadFacilitiesRecordBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  HyderabadFacilitiesRecordBuilder toBuilder() =>
      new HyderabadFacilitiesRecordBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is HyderabadFacilitiesRecord &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'HyderabadFacilitiesRecord')
...
class HyderabadFacilitiesRecordBuilder
    implements
        Builder<HyderabadFacilitiesRecord, HyderabadFacilitiesRecordBuilder> {
  _$HyderabadFacilitiesRecord? _$v;
  ...
  HyderabadFacilitiesRecordBuilder() {
    HyderabadFacilitiesRecord._initializeBuilder(this);
  }

  HyderabadFacilitiesRecordBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(HyderabadFacilitiesRecord other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$HyderabadFacilitiesRecord;
  }

  @override
  void update(void Function(HyderabadFacilitiesRecordBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  HyderabadFacilitiesRecord build() => _build();

  _$HyderabadFacilitiesRecord _build() {
    final _$result = _$v ??
        new _$HyderabadFacilitiesRecord._(
            column10: column10,
            column11: column11,
            column12: column12,
            column13: column13,

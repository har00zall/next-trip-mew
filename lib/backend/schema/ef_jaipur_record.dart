...
class EfJaipurRecord extends FirestoreRecord {
  EfJaipurRecord._(
  ...
  static Stream<EfJaipurRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => EfJaipurRecord.fromSnapshot(s));

  static Future<EfJaipurRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => EfJaipurRecord.fromSnapshot(s));

  static EfJaipurRecord fromSnapshot(DocumentSnapshot snapshot) =>
      EfJaipurRecord._(
        snapshot.reference,
  ...
  static EfJaipurRecord getDocumentFromData(
    ...
    DocumentReference reference,
      ...
      EfJaipurRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'EfJaipurRecord(reference: ${reference.path}, data: $snapshotData)';
}

...
part 'jaipur_record.g.dart';

abstract class JaipurRecord
    implements Built<JaipurRecord, JaipurRecordBuilder> {
  static Serializer<JaipurRecord> get serializer => _$jaipurRecordSerializer;
  ...
  static void _initializeBuilder(JaipurRecordBuilder builder) => builder
    ..hotelName = ''
    ..hotelAddress = ''
    ..rate = 0.0
    ..images = ''
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('jaipur');

  static Stream<JaipurRecord> getDocument(DocumentReference ref) => ref
      .snapshots()
      .map((s) => serializers.deserializeWith(serializer, serializedData(s))!);

  static Future<JaipurRecord> getDocumentOnce(DocumentReference ref) => ref
      .get()
      .then((s) => serializers.deserializeWith(serializer, serializedData(s))!);

  JaipurRecord._();
  factory JaipurRecord([void Function(JaipurRecordBuilder) updates]) =
      _$JaipurRecord;

  static JaipurRecord getDocumentFromData(
          Map<String, dynamic> data, DocumentReference reference) =>
      serializers.deserializeWith(serializer,
          {...mapFromFirestore(data), kDocumentReferenceField: reference})!;
}

Map<String, dynamic> createJaipurRecordData({
  String? hotelName,
  String? hotelAddress,
  double? rate,
  String? images,

...
class JaipurRecord extends FirestoreRecord {
  JaipurRecord._(
  ...
  static Stream<JaipurRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => JaipurRecord.fromSnapshot(s));

  static Future<JaipurRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => JaipurRecord.fromSnapshot(s));

  static JaipurRecord fromSnapshot(DocumentSnapshot snapshot) => JaipurRecord._(
        snapshot.reference,
  ...
  static JaipurRecord getDocumentFromData(
    ...
    DocumentReference reference,
      ...
      JaipurRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'JaipurRecord(reference: ${reference.path}, data: $snapshotData)';
}

...
part 'goa_record.g.dart';

abstract class GoaRecord implements Built<GoaRecord, GoaRecordBuilder> {
  static Serializer<GoaRecord> get serializer => _$goaRecordSerializer;
  ...
  static void _initializeBuilder(GoaRecordBuilder builder) => builder
    ..hotelName = ''
    ..hotelAddress = ''
    ..rate = 0.0
    ..images = ''
  ...
  static Stream<GoaRecord> getDocument(DocumentReference ref) => ref
      .snapshots()
      .map((s) => serializers.deserializeWith(serializer, serializedData(s))!);

  static Future<GoaRecord> getDocumentOnce(DocumentReference ref) => ref
      .get()
      .then((s) => serializers.deserializeWith(serializer, serializedData(s))!);

  GoaRecord._();
  factory GoaRecord([void Function(GoaRecordBuilder) updates]) = _$GoaRecord;

...
class ChennaiRecord extends FirestoreRecord {
  ChennaiRecord._(
  ...
  static Stream<ChennaiRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => ChennaiRecord.fromSnapshot(s));

  static Future<ChennaiRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => ChennaiRecord.fromSnapshot(s));

  static ChennaiRecord fromSnapshot(DocumentSnapshot snapshot) =>
      ChennaiRecord._(
        snapshot.reference,
  ...
  static ChennaiRecord getDocumentFromData(
    ...
    DocumentReference reference,
      ...
      ChennaiRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'ChennaiRecord(reference: ${reference.path}, data: $snapshotData)';
}

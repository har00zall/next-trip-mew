...
part 'hyderabad_record.g.dart';

abstract class HyderabadRecord
    implements Built<HyderabadRecord, HyderabadRecordBuilder> {
  static Serializer<HyderabadRecord> get serializer =>
      _$hyderabadRecordSerializer;
  ...
  static void _initializeBuilder(HyderabadRecordBuilder builder) => builder
    ..hotelName = ''
    ..hotelAddress = ''
    ..rate = 0.0
    ..images = ''
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('hyderabad');

  static Stream<HyderabadRecord> getDocument(DocumentReference ref) => ref
      .snapshots()
      .map((s) => serializers.deserializeWith(serializer, serializedData(s))!);

  static Future<HyderabadRecord> getDocumentOnce(DocumentReference ref) => ref
      .get()
      .then((s) => serializers.deserializeWith(serializer, serializedData(s))!);

  HyderabadRecord._();
  factory HyderabadRecord([void Function(HyderabadRecordBuilder) updates]) =
      _$HyderabadRecord;

  static HyderabadRecord getDocumentFromData(
          Map<String, dynamic> data, DocumentReference reference) =>
      serializers.deserializeWith(serializer,
          {...mapFromFirestore(data), kDocumentReferenceField: reference})!;
}

Map<String, dynamic> createHyderabadRecordData({
  String? hotelName,
  String? hotelAddress,
  double? rate,
  String? images,

...
class HyderabadRecord extends FirestoreRecord {
  HyderabadRecord._(
  ...
  static Stream<HyderabadRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => HyderabadRecord.fromSnapshot(s));

  static Future<HyderabadRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => HyderabadRecord.fromSnapshot(s));

  static HyderabadRecord fromSnapshot(DocumentSnapshot snapshot) =>
      HyderabadRecord._(
        snapshot.reference,
  ...
  static HyderabadRecord getDocumentFromData(
    ...
    DocumentReference reference,
      ...
      HyderabadRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'HyderabadRecord(reference: ${reference.path}, data: $snapshotData)';
}

...
part 'jaipur_policies_record.g.dart';

abstract class JaipurPoliciesRecord
    implements Built<JaipurPoliciesRecord, JaipurPoliciesRecordBuilder> {
  static Serializer<JaipurPoliciesRecord> get serializer =>
      _$jaipurPoliciesRecordSerializer;
  ...
  static void _initializeBuilder(JaipurPoliciesRecordBuilder builder) => builder
    ..column10 = ''
    ..column11 = ''
    ..column12 = ''
    ..column13 = ''
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('jaipurPolicies');

  static Stream<JaipurPoliciesRecord> getDocument(DocumentReference ref) => ref
      .snapshots()
      .map((s) => serializers.deserializeWith(serializer, serializedData(s))!);

  static Future<JaipurPoliciesRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then(
          (s) => serializers.deserializeWith(serializer, serializedData(s))!);

  JaipurPoliciesRecord._();
  factory JaipurPoliciesRecord(
          [void Function(JaipurPoliciesRecordBuilder) updates]) =
      _$JaipurPoliciesRecord;

  static JaipurPoliciesRecord getDocumentFromData(
          Map<String, dynamic> data, DocumentReference reference) =>
      serializers.deserializeWith(serializer,
          {...mapFromFirestore(data), kDocumentReferenceField: reference})!;
}

Map<String, dynamic> createJaipurPoliciesRecordData({
  String? column10,
  String? column11,
  String? column12,
  String? column13,

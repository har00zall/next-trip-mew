...
import 'e5_bus_review_model.dart';
export 'e5_bus_review_model.dart';

class E5BusReviewWidget extends StatefulWidget {
  const E5BusReviewWidget({Key? key}) : super(key: key);

  @override
  _E5BusReviewWidgetState createState() => _E5BusReviewWidgetState();
}

class _E5BusReviewWidgetState extends State<E5BusReviewWidget> {
  late E5BusReviewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => E5BusReviewModel());
  }

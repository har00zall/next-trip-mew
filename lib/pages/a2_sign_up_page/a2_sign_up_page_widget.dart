...
import 'a2_sign_up_page_model.dart';
export 'a2_sign_up_page_model.dart';

class A2SignUpPageWidget extends StatefulWidget {
  const A2SignUpPageWidget({Key? key}) : super(key: key);

  @override
  _A2SignUpPageWidgetState createState() => _A2SignUpPageWidgetState();
}

class _A2SignUpPageWidgetState extends State<A2SignUpPageWidget> {
  late A2SignUpPageModel _model;

...
class _F1HolidaysWidgetState extends State<F1HolidaysWidget> {
  late F1HolidaysModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => F1HolidaysModel());
  }

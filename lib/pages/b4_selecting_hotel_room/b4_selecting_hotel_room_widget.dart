...
import 'b4_selecting_hotel_room_model.dart';
...
class B4SelectingHotelRoomWidget extends StatefulWidget {
  ...
  _B4SelectingHotelRoomWidgetState createState() =>
      _B4SelectingHotelRoomWidgetState();
}

class _B4SelectingHotelRoomWidgetState
    extends State<B4SelectingHotelRoomWidget> {
  late B4SelectingHotelRoomModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => B4SelectingHotelRoomModel());
  }
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: FlutterFlowRadioButton(
                                      options: [
                                        FFLocalizations.of(context).getText(
                                          'hmovluef' /* Room with Breakfast */,
                                        ),
                                        FFLocalizations.of(context).getText(
                                          'de5z5msk' /* Room without Brealfast */,
                                        )
                                      ].toList(),
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: FlutterFlowRadioButton(
                                      options: [
                                        FFLocalizations.of(context).getText(
                                          'ue918hs2' /* Room with Breakfast */,
                                        ),
                                        FFLocalizations.of(context).getText(
                                          'axpb6br4' /* Room without Brealfast */,
                                        )
                                      ].toList(),
                                      onChanged: (val) => setState(() {}),
                                      controller:
